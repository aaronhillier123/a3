...
public class EmailController {
    ...
    public @ResponseBody
    String sendEmail(@RequestParam(value = "message") String message, @RequestParam(value = "sendAddress") String sendAddress, @RequestParam(value = "recieveAddress") String recieveAddress) throws SQLException, ClassNotFoundException, MessagingException {
        System.out.println("GOT EMAIL REQUEST");
        EmailService eServe = new EmailService();
        eServe.sendEmail(message, sendAddress, recieveAddress);
        return "SUCCESS";
    }
}
